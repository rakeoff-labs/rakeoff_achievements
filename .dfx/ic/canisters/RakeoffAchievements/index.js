...
import { idlFactory } from './RakeoffAchievements.did.js';
export { idlFactory } from './RakeoffAchievements.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.RAKEOFFACHIEVEMENTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./RakeoffAchievements.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the RakeoffAchievements canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./RakeoffAchievements.did.js")._SERVICE>}
 */
export const RakeoffAchievements = createActor(canisterId);
